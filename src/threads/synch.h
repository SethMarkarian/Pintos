...
void sema_update_priority(struct semaphore *, struct thread *);
...
<<<<<<< HEAD
    struct list_elem acquired_elem; /* to be stored in thread that holds lock */
    int priority; /* priority of highest-priority thread */
=======
    struct list_elem acquiredelem;
    int priority;
...
void lock_update_priority (struct lock *, struct thread *);
